            ...
            <div class="row">
                            ...
                            {{-- <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="payment-icon">
                                        <ul>
                                            <li><img class="img-fluid" src="/bookstore/images/payment-icon/1.png" alt=""></li>
                                            <li><img class="img-fluid" src="/bookstore/images/payment-icon/2.png" alt=""></li>
                                            <li><img class="img-fluid" src="/bookstore/images/payment-icon/3.png" alt=""></li>
                                            <li><img class="img-fluid" src="/bookstore/images/payment-icon/5.png" alt=""></li>
                                            <li><img class="img-fluid" src="/bookstore/images/payment-icon/7.png" alt=""></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    <div class="row">
                        ...
                        <div class="col-12 d-flex shopping-box"> <a href="{{ route('orders.sendMail') }}" class="ml-auto btn hvr-hover">Thanh toán</a> </div>
                    </div>
                </div>
            </div>
