  ...
  <footer>
            ...
            <div class="container">
				<div class="row">
					...
					<div class="col-lg-4 col-md-12 col-sm-12">
						<div class="footer-top-box">
							<h3>Mạng Xã Hội</h3>
							<p>Bạn có thể kết nối với chúng tôi thông qua các phương tiện mạng xã hội phổ biến dưới đây.</p>
							<ul>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-widget">
                            <h4>Giới Thiệu Về Nhà Sách Nhân Dân</h4>
							<p>Chúng tôi sở hữu hơn 100,000 đầu sách với nhiều thể loại phong phú, phục vụ độc giả ở mọi lứa tuổi. </p> 							
                            <p>Chúng tôi luôn cố gắng cập nhật những cuốn sách mới nhất bổ ích và lành mạnh đến với độc giả trong và ngoài nước. </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12 col-sm-12">
    ...
    <div class="footer-copyright">
        <p class="footer-company">Đã đăng kí bản quyền &copy; 2021 <a href="#">NHANDANBOOK</a> Thiết kế bởi :
