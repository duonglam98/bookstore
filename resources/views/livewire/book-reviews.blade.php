                        ...
                        <div class="relative z-10 h-auto p-4 py-10 overflow-hidden bg-white border-b-2 border-gray-300 rounded-lg shadow-2xl px-7">
                                    ...
                                    <form wire:submit.prevent="rate()">
                                        <div class="block max-w-3xl px-1 py-2 mx-auto">
                                            <div class="flex space-x-1 rating">
                                                <label for="star1">
                                                    <input hidden wire:model="review" type="radio" id="star1" name="rating" value="1" />
                            ...
                            @else
                                <div>
                                    ...
                                    <a href="/register" style="color: black !important; background-color: #b0b435"
                                        class="block px-5 py-2 mx-auto font-medium text-center text-black-600 border rounded-lg shadow-sm focus:outline-none hover:bg-gray-100" 
                                    >Đăng ký</a>
                                </div>
                            @endauth
                        </div>
